            ...
            <div class="modal-content">
                <form action="<?php echo FRONT_ROOT . "Cine/ModifyModal" ?>" method="post">
                    ...
                    <div class="modal-body pl-3 pr-3">
                        ...
                        <div class="row form-group pr-3">
                            <label class="col-6">Street</label>
                        ...
                        <div class="row pr-3">
                            <label class="col-12">Capacity: <?php echo $cine->getCapacidad() ?> personas.</label>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo FRONT_ROOT . "Cine/Add" ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add a new cinema</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
