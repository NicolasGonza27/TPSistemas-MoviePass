...
<div class="container content espaciado-sup">
    <div class="text-left mb-2">
        <a href="<?php echo FRONT_ROOT."Home/ShowFiltersViewsAdminOutCartelera"?>"><button type="button" class="btn btn-danger"><i class="fa fa-arrow-circle-left"> Back</i></button></a>
    </div>
