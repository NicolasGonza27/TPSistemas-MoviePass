  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form action="<?php echo ROOT_CLIENT ?>Usuario/Add" method="POST">

                    <div class="uk-margin">
                        <label for="" class="col-form-label">Nombre Completo</label>
                        <input type="text" name="nombreYApelido" class="uk-input" />
                    </div>

                    <div class="uk-margin">
                        <label for="" class="col-form-label">Dni</label>
                        <input type="number" name="dni" class="uk-input" />
                    </div>
                    ...
                    <div class="uk-margin">
                        ...
                        <input type="date" name="fecha_nac" class="uk-input" />
                    </div>
                </form>
      </div>
