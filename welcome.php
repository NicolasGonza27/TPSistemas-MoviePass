...
if(!isset($_SESSION['fbUserId']) and $_SESSION['fbUserId']==""){
	header('location: http://localhost/dashboard/TPSistemas-MoviePass/Home/FacebookLogin/index.php');
	exit;
}?>
<!doctype html>
...
<body>
	...
	<div class="container">
		<h1 class="text-center"><a href="http://localhost/dashboard/TPSistemas-MoviePass/Home/FacebookLogin">Login with Facebook using PHP SDK</a></h1>
    	<div class="row">
			<div class="col-sm-12 text-center p-5">
				...
				<p>email <em class="text-danger"><?php echo $_SESSION['email']?></em></p>
